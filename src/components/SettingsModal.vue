  ...
  data() {
    return {
      ...
      customTextFields: [
        ...
        { key: 'floatingQuickPickHint', label: 'Floating Window - Quick Pick Hint', fallback: 'Click to pick', section: 'window' },
        { key: 'trayHideMain', label: 'Tray Menu - Hide Main (window visible)', fallback: 'Hide Main', section: 'tray' },
        { key: 'trayShowMain', label: 'Tray Menu - Show Main (window hidden)', fallback: 'Show Main', section: 'tray' },
